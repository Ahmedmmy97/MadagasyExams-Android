...
import com.a33y.jo.madgasyexams.CustomFiles;
import com.a33y.jo.madgasyexams.ListItemClickListener;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder> {
    Context context;
    List<CustomFiles> files ;
    ListItemClickListener listItemClickListener;
    public RecyclerAdapter(Context context, List<CustomFiles> files) {
        this.context = context;
        this.files = files;
    }

    public RecyclerAdapter(Context context, List<CustomFiles> files, ListItemClickListener listItemClickListener) {
        this.context = context;
        this.files = files;
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder viewHolder, int i) {
           viewHolder.bind_data(files.get(i).getFileName(),i);
    }
